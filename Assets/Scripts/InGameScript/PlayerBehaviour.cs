...
public abstract class PlayerBehaviour : MonoBehaviour
{
    ...
    protected float GetRadiusFromStoneSize(CardData.StoneSize size)
    {
        switch (size)
        {
    ...
    protected float GetMassFromStoneWeight(CardData.StoneSize size, CardData.StoneWeight weight)
    {
        switch (weight)
        {
